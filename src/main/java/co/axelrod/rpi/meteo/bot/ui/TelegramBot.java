...
import co.axelrod.rpi.meteo.bot.config.token.TelegramTokenStorage;
import co.axelrod.rpi.meteo.bot.config.token.TelegramTokenStorageImpl;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    private TelegramTokenStorage telegramTokenStorage = new TelegramTokenStorageImpl();
    ...
    public void onUpdateReceived(Update update) {
        try {
            if ((update.hasMessage() && update.getMessage().hasText())) {
                ...
                execute(TelegramUtil.prepareMessage(telegramChatId, meteoSensor.getTemperatureInCelsius(), getKeyboard()));
            }
